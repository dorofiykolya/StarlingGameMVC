...
:: Android packaging
set AND_CERT_NAME="StarlingGameMVC"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\StarlingGameMVC.p12
...
set IOS_PROVISION=cert\StarlingGameMVC.mobileprovision
